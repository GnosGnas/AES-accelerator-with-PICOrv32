...
FIRMWARE_OBJS = firmware/start.o firmware/irq.o firmware/print.o firmware/AES_mem_mapped.o firmware/sieve.o firmware/multest.o firmware/stats.o
...
test_tb: AES/Testbench/tb.v AES/Top_module/AES.v AES/Encryption/AddRoundKey.v AES/Encryption/AES_encrypt.v AES/Encryption/MixColumns.v AES/Encryption/ShiftRows.v AES/Encryption/SubBytes.v AES/Decryption/AES_decrypt.v AES/Decryption/InvMixCols.v AES/Decryption/InvShiftrows.v AES/Decryption/InvSubBytes.v AES/Key_expansion_and_memory/Key_Expansion_Outer.v AES/Key_expansion_and_memory/AESKeyexpansion_128.v AES/Key_expansion_and_memory/AESKeyexpansion_192.v AES/Key_expansion_and_memory/AESKeyexpansion_256.v AES/Key_expansion_and_memory/current_word_gen_128.v AES/Key_expansion_and_memory/current_word_gen_192.v AES/Key_expansion_and_memory/current_word_gen_256.v AES/Key_expansion_and_memory/Key_mem.v
...
testbench_mod.vvp: testbench_mod.v axi4_mem_periph.v picorv32.v AES/Top_module/AES.v AES/Encryption/AddRoundKey.v AES/Encryption/AES_encrypt.v AES/Encryption/MixColumns.v AES/Encryption/ShiftRows.v AES/Encryption/SubBytes.v AES/Decryption/AES_decrypt.v AES/Decryption/InvMixCols.v AES/Decryption/InvShiftrows.v AES/Decryption/InvSubBytes.v AES/Key_expansion_and_memory/Key_Expansion_Outer.v AES/Key_expansion_and_memory/AESKeyexpansion_128.v AES/Key_expansion_and_memory/AESKeyexpansion_192.v AES/Key_expansion_and_memory/AESKeyexpansion_256.v AES/Key_expansion_and_memory/current_word_gen_128.v AES/Key_expansion_and_memory/current_word_gen_192.v AES/Key_expansion_and_memory/current_word_gen_256.v AES/Key_expansion_and_memory/Key_mem.v
	$(IVERILOG) -o $@ $(subst C,-DCOMPRESSED_ISA,$(COMPRESSED_ISA)) $^
	chmod -x $@
